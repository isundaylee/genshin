...
_ATTACKHITEFFECTRESULT = DESCRIPTOR.message_types_by_name['AttackHitEffectResult']
AttackHitEffectResult = _reflection.GeneratedProtocolMessageType('AttackHitEffectResult', (_message.Message,), {
  'DESCRIPTOR' : _ATTACKHITEFFECTRESULT,
  '__module__' : 'genshin.packet.proto.AttackHitEffectResult_pb2'
