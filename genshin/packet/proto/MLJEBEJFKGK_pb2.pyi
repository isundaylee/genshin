...
class MLJEBEJFKGK(_message.Message):
    __slots__ = ("IHGJLFCGFIN", "DAAKPCOABEP")
    IHGJLFCGFIN_FIELD_NUMBER: _ClassVar[int]
    DAAKPCOABEP_FIELD_NUMBER: _ClassVar[int]
    IHGJLFCGFIN: int
    DAAKPCOABEP: _KPFOBLALBLC_pb2.KPFOBLALBLC
    def __init__(self, IHGJLFCGFIN: _Optional[int] = ..., DAAKPCOABEP: _Optional[_Union[_KPFOBLALBLC_pb2.KPFOBLALBLC, str]] = ...) -> None: ...
