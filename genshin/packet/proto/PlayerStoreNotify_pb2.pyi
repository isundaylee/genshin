...
class PlayerStoreNotify(_message.Message):
    __slots__ = ("item_list", "weight_limit", "store_type")
    ...
    def __init__(self, item_list: _Optional[_Iterable[_Union[_Item_pb2.Item, _Mapping]]] = ..., weight_limit: _Optional[int] = ..., store_type: _Optional[_Union[_StoreType_pb2.StoreType, str]] = ...) -> None: ...
