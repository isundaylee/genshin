...
class PIKBBDHLPJJ(_message.Message):
    __slots__ = ("FGFLJIAEMLJ", "GJEBAJAJPII", "KLMDAPCLGAP")
    ...
    KLMDAPCLGAP: int
    def __init__(self, FGFLJIAEMLJ: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., GJEBAJAJPII: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., KLMDAPCLGAP: _Optional[int] = ...) -> None: ...
