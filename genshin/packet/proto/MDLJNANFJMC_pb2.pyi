...
class MDLJNANFJMC(_message.Message):
    __slots__ = ("OMKNBNMEBIK", "EFAJIHMNOBK", "JAHPPELNEDF", "IANEBDKAMBM", "NCCPPHNNPBF", "ODCPAECONND")
    ...
    NCCPPHNNPBF: int
    ODCPAECONND: int
    def __init__(self, OMKNBNMEBIK: _Optional[str] = ..., EFAJIHMNOBK: _Optional[str] = ..., JAHPPELNEDF: _Optional[_Iterable[_Union[_HFHJKHOPLMN_pb2.HFHJKHOPLMN, _Mapping]]] = ..., IANEBDKAMBM: _Optional[_Union[_PKJMPCPEGGO_pb2.PKJMPCPEGGO, _Mapping]] = ..., NCCPPHNNPBF: _Optional[int] = ..., ODCPAECONND: _Optional[int] = ...) -> None: ...
