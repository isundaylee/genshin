...
class GCFOFDEOPHC(_message.Message):
    __slots__ = ("BNJOJBOPMFJ",)
    ...
    def __init__(self, BNJOJBOPMFJ: _Optional[_Iterable[_Union[_JICKPPDLOHC_pb2.JICKPPDLOHC, _Mapping]]] = ...) -> None: ...
