...
class EAPGPNJCOJJ(_message.Message):
    __slots__ = ("LANJBJGNBOH", "IPCLFKLDKFA")
    ...
    def __init__(self, LANJBJGNBOH: _Optional[_Iterable[_Union[_IFPNJPJLNOF_pb2.IFPNJPJLNOF, _Mapping]]] = ..., IPCLFKLDKFA: _Optional[_Iterable[_Union[_IALLEKKFHCL_pb2.IALLEKKFHCL, _Mapping]]] = ...) -> None: ...
