...
class NGKGKPNCAIF(_message.Message):
    __slots__ = ("PJMIHEEDBDB",)
    ...
    def __init__(self, PJMIHEEDBDB: _Optional[_Iterable[_Union[_CJEIMOKENAM_pb2.CJEIMOKENAM, _Mapping]]] = ...) -> None: ...
