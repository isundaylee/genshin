...
class LEBFFEOPCGF(_message.Message):
    __slots__ = ("GJEBAJAJPII", "FGFLJIAEMLJ", "DAJHKHFLNDJ", "KEGOCIPPFIN")
    ...
    DAJHKHFLNDJ: int
    KEGOCIPPFIN: int
    def __init__(self, GJEBAJAJPII: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., FGFLJIAEMLJ: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., DAJHKHFLNDJ: _Optional[int] = ..., KEGOCIPPFIN: _Optional[int] = ...) -> None: ...
