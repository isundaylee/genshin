...
class CKLIKBENOOH(_message.Message):
    __slots__ = ("DOALEGICGKL", "GJEBAJAJPII", "NCCPPHNNPBF")
    ...
    NCCPPHNNPBF: int
    def __init__(self, DOALEGICGKL: _Optional[_Iterable[int]] = ..., GJEBAJAJPII: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., NCCPPHNNPBF: _Optional[int] = ...) -> None: ...
