...
class FLLFPGJCDEE(_message.Message):
    __slots__ = ("IJLFKCCOONM", "DNBEFLJLAMB")
    ...
    DNBEFLJLAMB: int
    def __init__(self, IJLFKCCOONM: _Optional[_Mapping[int, int]] = ..., DNBEFLJLAMB: _Optional[int] = ...) -> None: ...
