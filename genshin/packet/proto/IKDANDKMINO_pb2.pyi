...
class IKDANDKMINO(_message.Message):
    __slots__ = ("FGFLJIAEMLJ", "GJEBAJAJPII", "NCCPPHNNPBF")
    ...
    NCCPPHNNPBF: int
    def __init__(self, FGFLJIAEMLJ: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., GJEBAJAJPII: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., NCCPPHNNPBF: _Optional[int] = ...) -> None: ...
