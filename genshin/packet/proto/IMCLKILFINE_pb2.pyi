...
class IMCLKILFINE(_message.Message):
    __slots__ = ("AGHNEJINBFJ", "FHCNHPKKONG", "KKPEPKJACEF", "NMAHOMOGPHC", "IADFGKJCIDE")
    ...
    NMAHOMOGPHC: int
    IADFGKJCIDE: int
    def __init__(self, AGHNEJINBFJ: _Optional[_Iterable[float]] = ..., FHCNHPKKONG: _Optional[_Iterable[int]] = ..., KKPEPKJACEF: _Optional[_Iterable[str]] = ..., NMAHOMOGPHC: _Optional[int] = ..., IADFGKJCIDE: _Optional[int] = ...) -> None: ...
