...
_SYNCSCENEPLAYTEAMENTITYNOTIFY = DESCRIPTOR.message_types_by_name['SyncScenePlayTeamEntityNotify']
SyncScenePlayTeamEntityNotify = _reflection.GeneratedProtocolMessageType('SyncScenePlayTeamEntityNotify', (_message.Message,), {
  ...
  '__module__' : 'genshin.packet.proto.SyncScenePlayTeamEntityNotify_pb2'
