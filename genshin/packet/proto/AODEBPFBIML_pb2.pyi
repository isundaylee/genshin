...
class AODEBPFBIML(_message.Message):
    __slots__ = ("FGFLJIAEMLJ", "GJEBAJAJPII", "KJDMOOFKNEK")
    ...
    KJDMOOFKNEK: int
    def __init__(self, FGFLJIAEMLJ: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., GJEBAJAJPII: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., KJDMOOFKNEK: _Optional[int] = ...) -> None: ...
