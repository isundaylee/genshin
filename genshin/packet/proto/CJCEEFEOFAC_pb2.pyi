...
class CJCEEFEOFAC(_message.Message):
    __slots__ = ("prop_map", "AGIDBEEINDE")
    ...
    AGIDBEEINDE: int
    def __init__(self, prop_map: _Optional[_Mapping[int, _PropValue_pb2.PropValue]] = ..., AGIDBEEINDE: _Optional[int] = ...) -> None: ...
