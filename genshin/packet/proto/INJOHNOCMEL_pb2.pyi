...
class INJOHNOCMEL(_message.Message):
    __slots__ = ("FGAFONOJIPA", "AGIDBEEINDE", "EALJHPFDEHK")
    ...
    AGIDBEEINDE: int
    EALJHPFDEHK: int
    def __init__(self, FGAFONOJIPA: _Optional[_Union[_KDEHCGJAGFJ_pb2.KDEHCGJAGFJ, _Mapping]] = ..., AGIDBEEINDE: _Optional[int] = ..., EALJHPFDEHK: _Optional[int] = ...) -> None: ...
