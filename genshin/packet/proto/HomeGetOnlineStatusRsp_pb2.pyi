...
class HomeGetOnlineStatusRsp(_message.Message):
    __slots__ = ("retcode", "player_info_list")
    ...
    def __init__(self, retcode: _Optional[int] = ..., player_info_list: _Optional[_Iterable[_Union[_OnlinePlayerInfo_pb2.OnlinePlayerInfo, _Mapping]]] = ...) -> None: ...
