...
class NGINDEEFEAA(_message.Message):
    __slots__ = ("KABODNMEGEK", "OKKJCBOJAOD", "HKEGEBJNJJD")
    ...
    HKEGEBJNJJD: int
    def __init__(self, KABODNMEGEK: _Optional[_Iterable[_Union[_KIBLANEDMOA_pb2.KIBLANEDMOA, _Mapping]]] = ..., OKKJCBOJAOD: _Optional[_Union[_NCGPMHOIHHL_pb2.NCGPMHOIHHL, _Mapping]] = ..., HKEGEBJNJJD: _Optional[int] = ...) -> None: ...
