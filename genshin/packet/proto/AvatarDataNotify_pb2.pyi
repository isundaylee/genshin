...
class AvatarDataNotify(_message.Message):
    __slots__ = ("OPHDOKOFIHO", "KPIGEEJAMHM", "cur_avatar_team_id", "PBIOIIFOAPA", "avatar_rename_list", "temp_avatar_guid_list", "choose_avatar_guid", "avatar_list", "avatar_team_map")
    ...
    def __init__(self, OPHDOKOFIHO: _Optional[_Iterable[int]] = ..., KPIGEEJAMHM: _Optional[_Iterable[int]] = ..., cur_avatar_team_id: _Optional[int] = ..., PBIOIIFOAPA: _Optional[_Iterable[int]] = ..., avatar_rename_list: _Optional[_Iterable[_Union[_AvatarRenameInfo_pb2.AvatarRenameInfo, _Mapping]]] = ..., temp_avatar_guid_list: _Optional[_Iterable[int]] = ..., choose_avatar_guid: _Optional[int] = ..., avatar_list: _Optional[_Iterable[_Union[_AvatarInfo_pb2.AvatarInfo, _Mapping]]] = ..., avatar_team_map: _Optional[_Mapping[int, _AvatarTeam_pb2.AvatarTeam]] = ...) -> None: ...
