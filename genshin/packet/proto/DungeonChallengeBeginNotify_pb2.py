...
_DUNGEONCHALLENGEBEGINNOTIFY = DESCRIPTOR.message_types_by_name['DungeonChallengeBeginNotify']
DungeonChallengeBeginNotify = _reflection.GeneratedProtocolMessageType('DungeonChallengeBeginNotify', (_message.Message,), {
  'DESCRIPTOR' : _DUNGEONCHALLENGEBEGINNOTIFY,
  '__module__' : 'genshin.packet.proto.DungeonChallengeBeginNotify_pb2'
