...
class JKHPMJDMPJC(_message.Message):
    __slots__ = ("MDMKONDIDGE", "CPFFKAABOGD")
    ...
    CPFFKAABOGD: int
    def __init__(self, MDMKONDIDGE: _Optional[_Mapping[int, int]] = ..., CPFFKAABOGD: _Optional[int] = ...) -> None: ...
