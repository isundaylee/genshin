...
class BEOFOGIJBHF(_message.Message):
    __slots__ = ("DJMCHFPIFLM",)
    ...
    def __init__(self, DJMCHFPIFLM: _Optional[_Iterable[_Union[_LLGCDCDHDPD_pb2.LLGCDCDHDPD, _Mapping]]] = ...) -> None: ...
