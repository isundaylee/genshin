...
class AvatarExpeditionDataNotify(_message.Message):
    __slots__ = ("expedition_info_map",)
    ...
    def __init__(self, expedition_info_map: _Optional[_Mapping[int, _AvatarExpeditionInfo_pb2.AvatarExpeditionInfo]] = ...) -> None: ...
