...
class NMFLICIKEKF(_message.Message):
    __slots__ = ("IBEAKHHNOHB", "CJOKFLDEFMB")
    IBEAKHHNOHB_FIELD_NUMBER: _ClassVar[int]
    CJOKFLDEFMB_FIELD_NUMBER: _ClassVar[int]
    IBEAKHHNOHB: _HCJGIFNJPPJ_pb2.HCJGIFNJPPJ
    CJOKFLDEFMB: int
    def __init__(self, IBEAKHHNOHB: _Optional[_Union[_HCJGIFNJPPJ_pb2.HCJGIFNJPPJ, _Mapping]] = ..., CJOKFLDEFMB: _Optional[int] = ...) -> None: ...
