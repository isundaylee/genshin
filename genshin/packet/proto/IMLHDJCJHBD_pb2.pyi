...
from genshin.packet.proto import OKNBFFIFIGJ_pb2 as _OKNBFFIFIGJ_pb2
from genshin.packet.proto import FMFNEJNKFCJ_pb2 as _FMFNEJNKFCJ_pb2
...
class IMLHDJCJHBD(_message.Message):
    ...
    GCAGIBMOGKF_FIELD_NUMBER: _ClassVar[int]
    ...
    CGFHLLHIOJK_FIELD_NUMBER: _ClassVar[int]
    CIMHOFKDOCM_FIELD_NUMBER: _ClassVar[int]
    OEIHGDPIEOG_FIELD_NUMBER: _ClassVar[int]
    OEENIKOABOD_FIELD_NUMBER: _ClassVar[int]
    OAJOOBGHAGM_FIELD_NUMBER: _ClassVar[int]
    OIDOONLJGEI_FIELD_NUMBER: _ClassVar[int]
    OFAHCGINJIE_FIELD_NUMBER: _ClassVar[int]
    CEBLGCPAOJL_FIELD_NUMBER: _ClassVar[int]
    MMCHEGOOMLI_FIELD_NUMBER: _ClassVar[int]
    HDBFKNJHBOO_FIELD_NUMBER: _ClassVar[int]
    IGBDOEBPPHO_FIELD_NUMBER: _ClassVar[int]
    FALBFFNPGDJ: _KDEHCGJAGFJ_pb2.KDEHCGJAGFJ
    ...
    GCAGIBMOGKF: _KDEHCGJAGFJ_pb2.KDEHCGJAGFJ
