...
class JAHGJBJDHGG(_message.Message):
    __slots__ = ("HMLFALPADMC", "AGIDBEEINDE", "KBNHDNPJJBH")
    ...
    AGIDBEEINDE: int
    KBNHDNPJJBH: int
    def __init__(self, HMLFALPADMC: _Optional[_Union[_KNMPNCPBMMP_pb2.KNMPNCPBMMP, _Mapping]] = ..., AGIDBEEINDE: _Optional[int] = ..., KBNHDNPJJBH: _Optional[int] = ...) -> None: ...
