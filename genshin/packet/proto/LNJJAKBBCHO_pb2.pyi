...
class LNJJAKBBCHO(_message.Message):
    __slots__ = ("AGCILNPMBLB",)
    ...
    def __init__(self, AGCILNPMBLB: _Optional[_Iterable[_Union[_OMBEIFNNEDF_pb2.OMBEIFNNEDF, _Mapping]]] = ...) -> None: ...
