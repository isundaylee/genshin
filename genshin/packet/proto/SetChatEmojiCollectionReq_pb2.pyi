...
class SetChatEmojiCollectionReq(_message.Message):
    __slots__ = ("chat_emoji_collection_data",)
    ...
    def __init__(self, chat_emoji_collection_data: _Optional[_Union[_ChatEmojiCollectionData_pb2.ChatEmojiCollectionData, _Mapping]] = ...) -> None: ...
