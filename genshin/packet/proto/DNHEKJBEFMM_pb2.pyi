...
class DNHEKJBEFMM(_message.Message):
    __slots__ = ("HBKGBNKKCBG", "DNBEFLJLAMB")
    ...
    DNBEFLJLAMB: int
    def __init__(self, HBKGBNKKCBG: _Optional[_Mapping[int, int]] = ..., DNBEFLJLAMB: _Optional[int] = ...) -> None: ...
