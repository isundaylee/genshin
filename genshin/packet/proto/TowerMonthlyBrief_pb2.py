...
_TOWERMONTHLYBRIEF = DESCRIPTOR.message_types_by_name['TowerMonthlyBrief']
TowerMonthlyBrief = _reflection.GeneratedProtocolMessageType('TowerMonthlyBrief', (_message.Message,), {
  'DESCRIPTOR' : _TOWERMONTHLYBRIEF,
  '__module__' : 'genshin.packet.proto.TowerMonthlyBrief_pb2'
  # @@protoc_insertion_point(class_scope:TowerMonthlyBrief)
  })
_sym_db.RegisterMessage(TowerMonthlyBrief)
