...
class KDCDDGBKMEN(_message.Message):
    __slots__ = ("CJENICJPFGE", "EJNINFFFKJP")
    ...
    EJNINFFFKJP: int
    def __init__(self, CJENICJPFGE: _Optional[_Mapping[int, _IGKLNNDNCMG_pb2.IGKLNNDNCMG]] = ..., EJNINFFFKJP: _Optional[int] = ...) -> None: ...
