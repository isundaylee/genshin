...
class PCFGCOIFDMM(_message.Message):
    __slots__ = ("item_list", "NCCPPHNNPBF")
    ...
    NCCPPHNNPBF: int
    def __init__(self, item_list: _Optional[_Iterable[_Union[_JICKPPDLOHC_pb2.JICKPPDLOHC, _Mapping]]] = ..., NCCPPHNNPBF: _Optional[int] = ...) -> None: ...
