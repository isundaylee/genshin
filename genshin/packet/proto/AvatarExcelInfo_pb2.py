...
_AVATAREXCELINFO = DESCRIPTOR.message_types_by_name['AvatarExcelInfo']
AvatarExcelInfo = _reflection.GeneratedProtocolMessageType('AvatarExcelInfo', (_message.Message,), {
  'DESCRIPTOR' : _AVATAREXCELINFO,
  '__module__' : 'genshin.packet.proto.AvatarExcelInfo_pb2'
  # @@protoc_insertion_point(class_scope:AvatarExcelInfo)
  })
_sym_db.RegisterMessage(AvatarExcelInfo)
