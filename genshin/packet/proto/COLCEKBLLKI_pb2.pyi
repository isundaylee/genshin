...
class COLCEKBLLKI(_message.Message):
    __slots__ = ("BBOPFHAODOP", "HGGEHLMHKMP", "EAIPGEMKNPO", "FINAHGLFHAG")
    ...
    EAIPGEMKNPO: int
    FINAHGLFHAG: int
    def __init__(self, BBOPFHAODOP: _Optional[_Iterable[_Union[_AJMIMBMCABE_pb2.AJMIMBMCABE, _Mapping]]] = ..., HGGEHLMHKMP: _Optional[int] = ..., EAIPGEMKNPO: _Optional[int] = ..., FINAHGLFHAG: _Optional[int] = ...) -> None: ...
