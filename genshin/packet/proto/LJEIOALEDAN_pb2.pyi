...
class LJEIOALEDAN(_message.Message):
    __slots__ = ("LPAGGIOGCJK", "DAAKPCOABEP")
    ...
    def __init__(self, LPAGGIOGCJK: _Optional[_Iterable[_Union[_CACGLIBJIIE_pb2.CACGLIBJIIE, _Mapping]]] = ..., DAAKPCOABEP: _Optional[_Union[_KPFOBLALBLC_pb2.KPFOBLALBLC, str]] = ...) -> None: ...
