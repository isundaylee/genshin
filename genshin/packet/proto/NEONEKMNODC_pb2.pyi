...
class NEONEKMNODC(_message.Message):
    __slots__ = ("NPFFLKNKFND", "AGIDBEEINDE")
    NPFFLKNKFND_FIELD_NUMBER: _ClassVar[int]
    AGIDBEEINDE_FIELD_NUMBER: _ClassVar[int]
    NPFFLKNKFND: _HFFFCNEFIKM_pb2.HFFFCNEFIKM
    AGIDBEEINDE: int
    def __init__(self, NPFFLKNKFND: _Optional[_Union[_HFFFCNEFIKM_pb2.HFFFCNEFIKM, _Mapping]] = ..., AGIDBEEINDE: _Optional[int] = ...) -> None: ...
